...
const darius = new Author("darius")
 
const post = darius.writePost("titulo post", "lorfmkmfwfwprorfwofmmfwjfliwe")

post.addComent("isac", "braboz")

post.addComent("linux", "show")
